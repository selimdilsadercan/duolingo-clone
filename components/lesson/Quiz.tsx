...
import { reduceHearts } from "@/helpers/user-progress";
import { useHeartsModal } from "@/hooks/use-hearts-modal";
import { usePracticeModal } from "@/hooks/use-practice-modal";
import { upsertChallengeProgress } from "@/helpers/challange-progress";
...
function Quiz({ initialPercentage, initialHearts, initialLessonId, initialLessonChallenges, userSubscription }: Props) {
